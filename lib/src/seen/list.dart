...
class listScreen extends StatefulWidget {
  listScreen({Key? key,required this.username,required this.password,required this.userid,required this.wordlist})
   : super(key: key);
  final String? username;
  final String? password;
  final List<WordListData>? wordlist;
  final int userid;
  @override
                  ...
                  child: Scrollbar(
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return  WordContainer(worddata: widget.wordlist![index]);
                      },
                    ),
                  ),
